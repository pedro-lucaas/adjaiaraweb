...
const card1 = { id: 0, title: "Culto Online", href: "home/culto-online", img: Img1 }
...
export default class Cards extends Component {
    render(){
        ...
        <div key={nome.id} className="shadow-lg card border-0" data-wow-duration="500ms" data-wow-delay="400ms">
